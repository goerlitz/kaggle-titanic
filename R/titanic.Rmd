...
plot(perf, colorize=T, lwd= 3, main= "ROC Curve - Random Forest")

# AUC
print(paste("auc: ", unlist(performance(pred, "auc")@y.values)))
print(paste("max acc: ", max(unlist(performance(pred, "acc")@y.values))))
